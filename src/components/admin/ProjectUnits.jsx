...
export default function ProjectUnits({ projectId }) {
    ...
    if (loading && !units.length) return <div className="p-8 text-center"><Loader2 className="w-8 h-8 animate-spin mx-auto text-accent" /></div>;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none"
                        ...
                        <div>
                            ...
                            <select 
                                ...
                                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none bg-white"
                            >
