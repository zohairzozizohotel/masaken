...
export default function ProjectFiles({ projectId }) {
    ...
    if (loading && !files.length) return <div className="p-8 text-center"><Loader2 className="w-8 h-8 animate-spin mx-auto text-accent" /></div>;
            ...
            <div className="flex justify-between items-center">
                ...
                <div>
                    ...
                    <label 
                        ...
                        className={`flex items-center gap-2 bg-accent text-white px-4 py-2 rounded-lg hover:bg-accent/90 transition-colors cursor-pointer ${uploading ? 'opacity-50 pointer-events-none' : ''}`}
                    >
                        ...
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <div className="flex gap-2">
                                <a 
                                    ...
                                    target="_blank" 
                                    rel="noreferrer" 
                                    className="p-1.5 text-gray-500 hover:text-accent hover:bg-accent/5 rounded-lg transition-colors"
                                    title="مشاهدة"
                                >
                                    <Eye size={18} />
                                </a>
